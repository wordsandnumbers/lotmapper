...
from app.services.stream import PROGRESS_STREAM, STREAM_PORT, _parse_amqp_url
...
async def main():
    ...
    async with Producer(host=stream_host, port=STREAM_PORT, username=stream_user, password=stream_pass) as producer:
